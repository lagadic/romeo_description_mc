...
# this import only adds the proper path for interactive_marker_helper
import mc_solver

from interactive_marker_helper import createBoxMarker, create6DofInteractive, \
...
from eigen3 import toNumpy, Vector3d, Matrix3d
